...
import SortFilterMenu, { DEFAULT_PANTRY_FILTERS } from '@/components/pantry/SortFilterMenu';
...
describe('SortFilterMenu', () => {
  it('marks the current sort option as checked', () => {
    render(
      <SortFilterMenu
        ...
        filters={DEFAULT_PANTRY_FILTERS}
  ...
  it('resets filters to the default via "Clear filter", and disables that button when already at the default', () => {
    ...
    expect(onFiltersChange).toHaveBeenCalledWith(DEFAULT_PANTRY_FILTERS);
