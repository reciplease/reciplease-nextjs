export type InventorySortBy = 'name' | 'dateAdded' | 'expiration';

export interface InventoryFilters {
  partiallyEaten: boolean;
}

export const DEFAULT_INVENTORY_FILTERS: InventoryFilters = { partiallyEaten: false };
...
export default function SortFilterMenu({ sortBy, onSortByChange, filters, onFiltersChange, onClose }: SortFilterMenuProps) {
  return (
    // z-[60], not z-50: InventoryFab (and its siblings for other sections) render
      ...
      >
        ...
        <fieldset className="mt-4 grid gap-2 border-0 p-0">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => onFiltersChange(DEFAULT_INVENTORY_FILTERS)}
              disabled={filters.partiallyEaten === DEFAULT_INVENTORY_FILTERS.partiallyEaten}
