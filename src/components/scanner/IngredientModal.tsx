...
export default function IngredientModal({ suggestedName, matches, onSelect, onClose }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 bg-black/65 flex items-end sm:items-center justify-center z-50"
      onClick={onClose}
    >
      <div
        className="bg-zinc-900 text-white rounded-t-2xl sm:rounded-2xl w-full max-w-md max-h-[80dvh] overflow-y-auto flex flex-col gap-3 p-6"
