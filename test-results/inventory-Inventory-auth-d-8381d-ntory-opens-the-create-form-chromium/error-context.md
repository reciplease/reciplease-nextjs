...
- Name: inventory.spec.ts >> Inventory (auth disabled) >> "add to inventory" opens the create form
- Location: e2e\inventory.spec.ts:59:7
...
Call log:
  - waiting for getByRole('link', { name: /add to inventory/i })
