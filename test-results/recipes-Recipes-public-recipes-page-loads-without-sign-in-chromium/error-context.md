...
- Name: recipes.spec.ts >> Recipes (public) >> recipes page loads without sign-in
- Location: e2e\recipes.spec.ts:4:7
...
Locator: getByRole('heading', { name: /recipes/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /recipes/i })
